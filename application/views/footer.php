		<div class="legal-footer">
			<a href="<?=base_url(TRUE)?>imprint" class="legal-footer-link">imprint</a><span class="dot-delimiter">•</span><a href="<?=base_url(TRUE)?>privacy" class="legal-footer-link">privacy policy</a>
		</div>
	</div>
</div>
<!--+++++++++++++++++++++++++ sidebar +++++++++++++++++++++++++-->
<div id="sidebar" class="<?=variable($sidebar_class)?> regular no-flicker dark-black">
	...
	<div id="sidebar_bottom">
		<ul id="follow_nav">
			...
			<li class="item">
				<a class="hover-button mail" href="mailto:lukas@vea.re" target="_blank" data-link-tracking="sidebar-email">
